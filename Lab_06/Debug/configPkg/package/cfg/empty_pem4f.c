...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[8101];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/TIRTOS_Workshop_Labs/Lab_06/Project/Debug/configPkg/package/cfg/empty_pem4f");
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1fa5;
...
#endif
#endif
const ti_sysbios_family_arm_m3_Hwi_Handle Call_ISR = (ti_sysbios_family_arm_m3_Hwi_Handle)((ti_sysbios_family_arm_m3_Hwi_Handle)&ti_sysbios_family_arm_m3_Hwi_Object__table__V[0]);
